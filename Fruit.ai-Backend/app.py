...
# Configure MongoDB
app.config['MONGO_URI'] = 'mongodb+srv://manvi0862be21:Manvi1709Grover@cluster0.nx4hh.mongodb.net/FRUITS.AI-APPRECIATE-WEALTH-TASK?retryWrites=true&w=majority'
mongo = PyMongo(app)
if mongo.db is None:
